package com.welink.biz.common.pay.service;
...
public class AlipayService {
     ...
     * @return 表单提交HTML信息
     */
    // public static String create_vip_direct_pay_by_user(
    // Map<String, String> sParaTemp) {
    //
    // // 增加基本配置
    // sParaTemp.put("service", "create_direct_pay_by_user");
    // sParaTemp.put("partner", AlipayConfig.partner);
    // sParaTemp.put("return_url", AlipayConfig.vip_return_url);
    // sParaTemp.put("notify_url", AlipayConfig.vip_notify_url);
