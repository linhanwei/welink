...
public class AlipayCore {
    ...
    public static LinkedHashMap<String, String> paraFilterForH5(Map<String, String> sArray) {
    ...
    public static String createLinkStringNOSortForH5new(Map<String, String> params) {
    ...
    public static String createLinkStringNoSortForH5(Map<String, String> params) {
        //手机网站支付MD5签名固定参数排序，顺序参照文档说明
        StringBuilder gotoSign_params = new StringBuilder();
        gotoSign_params.append("service=" + params.get("service"));
        gotoSign_params.append("&v=" + params.get("v"));
     ...
     * @return 拼接后字符串
     */
    public static String createLinkStringWhitInclude(Map<String, String> params) {
