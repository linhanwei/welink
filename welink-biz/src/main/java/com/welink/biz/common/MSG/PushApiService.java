...
import com.welink.biz.common.model.PushSource;
...
public class PushApiService {
    ...
    private static final String AVOS_APP_ID_VALUE_PRE = "AaBmEWTPTYAB9jquoWv8mWfA";

    private static final String AVOS_APP_KEY = "X-AVOSCloud-Application-Key";

    private static final String AVOS_APP_KEY_VALUE_PRE = "MSuVjiuLFCA5YAYcHMF8ylDA";
     ...
     * @return
     */
    public String pushLinkMsg(String action, String userId, String alertContent, long bizType, long linkMsgCnt, boolean isPre) {
        DefaultHttpClient httpclient = new DefaultHttpClient();

        // 目标地址
        HttpPost httppost = new HttpPost(AVOS_PUSH_URL);// new HttpPost(AVOS_PUSH_URL);
        if (isPre) {
            httppost.addHeader(AVOS_APP_ID, AVOS_APP_ID_VALUE_PRE);
            httppost.addHeader(AVOS_APP_KEY, AVOS_APP_KEY_VALUE_PRE);
        } else {
            httppost.addHeader(AVOS_APP_ID, pushSource.getAvosAppIdValue());
            httppost.addHeader(AVOS_APP_KEY, pushSource.getAvosAppClientKey());
        }
        String body = null;
    ...
    public String pushMsgWithoutAlert(String action, String uId, long linkCnt, boolean isPre) {

        DefaultHttpClient httpclient = new DefaultHttpClient();

        // 目标地址
        HttpPost httppost = new HttpPost(AVOS_PUSH_URL);
     ...
     * @return
     */
    public String pushMsg(String action, String content, String url, String uId, String title, long bizType, boolean isPre, long tradeId) {
        ...
        if (isPre) {
            ...
            httppost.addHeader(AVOS_APP_ID, "wtzdt5kmqsd4yhta6kbggh3f8cmexn6grgndyxc3byetjt4b");
            httppost.addHeader(AVOS_APP_KEY, "evn3bgnfqhzp2macj4fkciajmsotq5p86aofjwo688rqr4p6");
        }
        String body = null;
    ...
    public String pushMsg2CommunityMembers(String action, String content, String url, String communityId, String title, long bizType, long tradeId, boolean isPre) {
    ...
    public String pushMsg2Channel(String action, String content, String url, String communityId, String title, long bizType, boolean isPre) {
     ...
     * @param status
     */
    private void parseErrorViaStatus(int status) {
        if (200 == status) {
    ...
    public static void main(String[] args) {
        String uid1 = PhenixUserHander.encodeUserId(38l);//userid  chaochao 15  xiaofei 14
        System.out.println(uid1);

        String uid = PhenixUserHander.encodeUserId(4981l);//userid  chaochao 15  xiaofei 14
        System.out.println(uid);
        //new PushApiService().pushMsg("1", "AVOS！你好", "", uid, "11111", 2, false, 2l);
    }
}
