 ...
 * 此外, 如果字段对象没有重载实现自定义的toString方法, 则通过{@link org.apache.commons.lang.builder.ToStringBuilder}反射输出
 *
 * @author beneo
 */
public class NoNullFieldStringStyle extends ToStringStyle {
    ...
    private static final long serialVersionUID = -1329401825958579204L;
