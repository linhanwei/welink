...
public class TimeUtils {
    ...
    public static final int JS_API_TICKET_TIMEOUT = 7200;

    private static org.slf4j.Logger log = LoggerFactory.getLogger(TimeUtils.class);

    public final static int TIME_DAY_MILLISECOND = 86400000;

    public static final long TIME_1_MONTH_MILi = 2592000000l;

    public static final int TIME_1_MONTH_SEC = 2592000;

    // /
    // 定义时间日期显示格式 2013-08-22 14:45:24
    // /
     ...
     */
    public String getFormatDate(java.util.Date currDate) {
     ...
     */
    public Date getFormatDateToDate(java.util.Date currDate) {
     ...
     */
    public Date getFormatDateToDate_CN(java.util.Date currDate) {
     ...
     */
    public Date getFormatDate(String currDate) {
        return getFormatDate(currDate, DATE_FORMAT);
    }
     ...
     * @see #getFormatDate(String, String)
     */
    public Date getFormatDate_CN(String currDate) {
     ...
     */
    public String getFormatDateTime(java.util.Date currDate) {
     ...
     */
    public Date getFormatDateTimeToTime(java.util.Date currDate) {
     ...
     */
    public Date getFormatDateTime(String currDate) {
        return getFormatDateTime(currDate, TIME_FORMAT);
    }
     ...
     * @see #getFormatDateTime(java.util.Date, String)
     */
    public String getFormatDateTime_CN(java.util.Date currDate) {
     ...
     */
    public Date getFormatDateTimeToTime_CN(java.util.Date currDate) {
     ...
     * @see #getFormatDateTime(String, String)
     */
    public Date getFormatDateTime_CN(String currDate) {
        return getFormatDateTime(currDate, TIME_FORMAT_CN);
    }
     ...
     */
    public String getFormatDateTime(java.util.Date currDate, String format) {
        if (currDate == null) {
            return "";
        }
     ...
     * @see java.text.SimpleDateFormat#parse(java.lang.String)
     */
    public Date getFormatDateTime(String currDate, String format) {
        if (currDate == null) {
            return null;
        }
        SimpleDateFormat dtFormatdB = null;
     ...
     */
    public String getDateBeforeMonth(int number) {
        Calendar cal = Calendar.getInstance();
        cal.add(Calendar.MONTH, -number);
        return getFormatDate(cal.getTime(), DATE_FORMAT);
    }

    public long getDaysOfDates(Date first, Date second) {
     ...
     * @return int 相差的天数
     */
    public int getDaysBetweenDates(Date first, Date second) {
        Date d1 = getFormatDateTime(getFormatDate(first), DATE_FORMAT);
        Date d2 = getFormatDateTime(getFormatDate(second), DATE_FORMAT);
     ...
     * @return int 相差的天数
     */
    public int getDaysBetweenDates(String first, String second) {
     ...
     */
    public List<Date> getDaysListBetweenDates(Date first, Date second) {
     ...
     * @see #getFormatDate(java.util.Date, String)
     */
    public String getCurrDateStr_CN() {
     ...
     * @see #getFormatDateTime(java.util.Date, String)
     */
    public String getCurrDateTimeStr_CN() {
     ...
     */
    public Date getDateBeforeOrAfter(int iDate) {
        Calendar cal = Calendar.getInstance();
     ...
     * @see #getFormatDate(java.util.Date, String)
     */
    public String getFormatMonth(java.util.Date currDate) {
        return new TimeUtils().getFormatDate(currDate, MONTH_FORMAT);
    }
     ...
     * @see #getFormatDate(java.util.Date, String)
     */
    public String getFormatDay(java.util.Date currDate) {
        return new TimeUtils().getFormatDate(currDate, DAY_FORMAT);
    }
    ...
    public String getFirstDayOfMonth() {
        ...
        return new TimeUtils().getFormatDate(cal.getTime(), DATE_FORMAT);
    }
     ...
     * @see #getFormatDate(java.util.Date, String)
     */
    public String getFirstDayOfMonth(Date currDate) {
        Calendar cal = Calendar.getInstance();
     ...
     * @see #getFormatDate(java.util.Date, String)
     */
    public String getLastDayOfMonth(Date currDate) {
        Calendar cal = Calendar.getInstance();
        cal.setTime(currDate);
     ...
     * @see java.util.Calendar#add(int, int)
     */
    public Date getDateBeforeOrAfterHours(Date curDate, int iHour) {
        Calendar cal = Calendar.getInstance();
        cal.setTime(curDate);
     ...
     * @return
     */
    public boolean isSameWeek(Date curDate, Date compareDate) {
     ...
     */
    public String addDateEndfix(String datestring) {
     ...
     * @return
     */
    public Date getFormatDateEndfix(String dateStr) {
     ...
     * @return
     */
    public Date formatEndTime(String datePre) {
        if (datePre == null)
            return null;
    ...
    public Boolean compareDay(Date date1, int compday) {
        if (date1 == null)
            return false;
     ...
     */
    public String convertBinaryTime2Hex(String timespan) {
     ...
     */
    public String convertHexTime2Binary(String timespan) {
        if (timespan == null || timespan.equals("")) {
            return "";
        }
     ...
     * @return 一个48位的二进制串，如："011111111011111111111111111111111111111111111110"
     */
    public String convertDecTime2Binary(String timespan) {
        if (timespan == null || timespan.equals("")) {
            return "";
        }
     ...
     */
    public String convertBinaryTime2Dec(String timespan) {
        if (timespan == null || timespan.equals("")) {
            return "";
        }
     ...
     * @return
     */
    public String genericSpecdate(Date date, int addMonth, int monthDay) {
        Calendar cal = Calendar.getInstance();
        cal.setTime(date);
     ...
     * @return
     */
    public Date getDateBeforeOrAfterV2(int idx) {
     ...
     * @return curDate
     */
    public Date getSpecifiedDateTimeBySeconds(Date curDate, int seconds) {
     ...
     * @return curDate
     */
    public Date getSpecifiedDateTime_235959(Date curDate) {
        return getSpecifiedDateTimeBySeconds(getFormatDateToDate(curDate), 24 * 60 * 60 - 1);
    }

    public String getSpecifiedDateTime_month(Date curDate) {
     ...
     * @return
     */
    public String getDiffStringDate(Date dt, int diff) {
     ...
     * @return
     */
    public final String dtSimpleFormat(Date date) {
        if (date == null) {
            return "";
        }
    ...
    private final DateFormat getFormat(String format) {
     ...
     * @author Alvise
     */
    public int maxContinuousDays(Date[][] startDateAndEndDate) {
        // 冒泡排序
        for (int i = 0; i < startDateAndEndDate.length - 1; i++) {
            for (int j = 0; j < startDateAndEndDate.length - i - 1; j++) {
                if (getDaysBetweenDates(startDateAndEndDate[j + 1][0],
        ...
        for (int i = 0; i < startDateAndEndDateNew.length; i++) {
            ...
            while (j < startDateAndEndDate.length) {
                if (getDaysBetweenDates(startDateAndEndDateNew[i][1],
                        startDateAndEndDate[j][0]) > 0) {
                    break;
                } else if (getDaysBetweenDates(startDateAndEndDateNew[i][1],
        ...
        for (int i = 0; i < startDateAndEndDateNew.length - 1; i++) {
            ...
            int temDays = getDaysBetweenDates(curEndDate, nextStartDate);
            if (temDays > maxDays) {
                maxDays = temDays;
            }
        }
     ...
     * @author Alvise
     */
    public int maxContinuousDays(String dateStr) {
        ...
        for (int i = 0; i < seDate.length; i++) {
            ...
            startDateAndEndDate[i][0] = getFormatDate(tempDate[0]);
            startDateAndEndDate[i][1] = getFormatDate(tempDate[1]);
        }
     ...
     */
    public boolean isConfilct(String begintimeOne, String endtimeOne, String begintimeTwo,
                              String endtimeTwo) {
     ...
     * @return 最高可购买时间
     */
    public String getCansellTime(String busytimes, int days) {
    ...
    public static String date2StrMini(Date date) {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm");
        return sdf.format(date);
    }


    public Date _str2DateTime(String str) {
        Date date = new Date();
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        try {
            date = sdf.parse(str);
    ...
    public String _date2Str(Date date) {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        return sdf.format(date);
    }

    public String cts2hms(long lTime) {
    ...
    public Date getDateBeforeOrAfter(Date curDate, int iDate) {
        Calendar cal = Calendar.getInstance();
        cal.setTime(curDate);
        cal.add(Calendar.DAY_OF_MONTH, iDate);
        return cal.getTime();
    ...
    public String getStrDateBeforeOrAfter(Date curDate, int iDate) {
        Calendar cal = Calendar.getInstance();
        cal.setTime(curDate);
        cal.add(Calendar.DAY_OF_MONTH, iDate);
    ...
    public long getTimeBeforeOrAfterMonths(Date curDate, int iDate) {
        Calendar cal = Calendar.getInstance();
        cal.setTime(curDate);
        cal.add(Calendar.DAY_OF_MONTH, iDate);
    ...
    public long getTimeBeforeOrAfterDays(Date curDate, int iDate) {
        Calendar cal = Calendar.getInstance();
        cal.setTime(curDate);
        cal.add(Calendar.DAY_OF_MONTH, iDate);
        return cal.getTime().getTime();
    ...
    public static Date getDateAfterMonth_D(Date curDate, int number) {
        Calendar cal = Calendar.getInstance();
        cal.setTime(curDate);
        cal.add(Calendar.MONTH, number);
        return cal.getTime();
    ...
    public String getFormatDate_CN(java.util.Date currDate) {
        return getFormatDate(currDate, DATE_FORMAT_CN);
    }
     ...
     * @see java.text.SimpleDateFormat#format(java.util.Date)
     */
    public String getFormatDate(java.util.Date currDate, String format) {
        if (currDate == null) {
            return "";
        }
        SimpleDateFormat dtFormatdB = null;
    ...
    public static void main(String[] args) {
        String s = "2013-02-28 15:30:22";
        String s1 = "2013-02-28 15:29:22";
        TimeUtils timeUtils = new TimeUtils();
//        System.out.println(timeUtils.getStrDateBeforeOrAfter(str2DateTime(s), 0));
        Date d1 = str2DateTime(s);
        Date d2 = str2DateTime(s1);
        long minis = (d1.getTime() - d2.getTime()) / 1000;
//        System.out.print(minis);
    }
}
