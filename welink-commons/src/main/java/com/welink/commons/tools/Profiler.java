package com.welink.commons.tools;
...
public final class Profiler {
    ...
    public static void tracing(String format, Object... objects) {
        String message = MessageFormatter.arrayFormat(format, objects).getMessage();
        logger.info(message);
        enter(message);
    }
    ...
    public static final class Entry {
        ...
        public String getMessage() {
            ...
            return org.apache.commons.lang.StringUtils.defaultIfEmpty(messageString, null);
        }
        ...
        public List<Entry> getSubEntries() {
            return unmodifiableList(subEntries);
        }
