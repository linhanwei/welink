...
public class OrderDetail {
    ...
    private static org.slf4j.Logger log = LoggerFactory.getLogger(OrderDetail.class);
    ...
    @RequestMapping(value = {"/api/h/1.0/orderDetail.htm"}, produces = "text/html;charset=utf-8")
