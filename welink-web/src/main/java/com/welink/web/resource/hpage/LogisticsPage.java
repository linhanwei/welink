 ...
 * File Name:LogisticsPage.java
 * Package Name:com.welink.web.resource.hpage
 * Date:2016年3月21日下午8:07:37
...
/**
 * ClassName:LogisticsPage <br/>
 * Function: TODO ADD FUNCTION. <br/>
 * Reason:	 TODO ADD REASON. <br/>
 * Date:     2016年3月21日 下午8:07:37 <br/>
 * @author   LuoGuangChun
 * @version  
 * @since    JDK 1.6
 * @see 	 
...
public class LogisticsPage {
    ...
    @RequestMapping(value = {"/api/h/1.0/logisticsInfoPage.htm"}, produces = "text/html;charset=utf-8")
    public String execute(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
        ...
        if (UserUtils.redirect(session)) {
            response.sendRedirect("/api/h/1.0/vLoginPage.htm?refurl=logisticsInfoPage.htm");
            return null;
        }
